...
export const SECOES_CONFIGURACOES = [
  ...
  { id: 'financeiro', label: 'Financeiro', ordem: 45 },
...
export const NAV_MODULES = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'cfg-responsaveis-obras', ordem: 16, secaoConfig: 'usuarios', ordemConfig: 25, label: 'Responsáveis por obra', desc: 'Responsáveis e substitutos compartilhados por Custos e Recebíveis e transferências do Pessoal.', icon: HiOutlineUsers, to: '/configuracoes-responsaveis-obras', can: canManageResponsaveisObra },
      ...
      { id: 'cfg-status-internos-pagar', ordem: 64, secaoConfig: 'financeiro', ordemConfig: 10, label: 'Status internos do Contas a Pagar', desc: 'Classificações internas para acompanhar títulos a pagar.', icon: HiOutlineClipboardDocumentList, to: '/configuracoes-status-internos-pagar', can: (user) => canAccessFinanceiro(user) },
      ...
      { id: 'cfg-titulos-pedidos', ordem: 85, secaoConfig: 'compras', ordemConfig: 25, label: 'Categorias dos Títulos', desc: 'Categorias permitidas e padrão para títulos criados por Compras.', icon: HiOutlineAdjustmentsHorizontal, to: '/configuracoes-titulos-pedidos-compra', can: (user) => isSuperadmin(user) },
      ...
      */
      ...
      { id: 'cfg-controle-diario-contas', ordem: 405, secaoConfig: 'status-vinculos', ordemConfig: 225, label: 'Controle Diário de Contas', desc: 'Ative o bloqueio e defina responsáveis pela conciliação e aprovação de divergências.', icon: HiOutlineBanknotes, to: '/configuracoes-controle-diario-contas', can: (user) => hasEnabledModule(user, 'FINANCEIRO') && isSuperadmin(user) },
